<?php
    ...
    if ($arr_config_premium[$device]['theme'] != 0) {
        $kits_path = $cdn_kits."/apps/app".$arr_config_premium[$device]['theme'].'/'.$arr_config_premium['kit_version'].'/';
    } else {
...
<head>
    ...
    <title><?php echo urldecode($arr_config_premium['title']);?></title>
    <style type="text/css">
        /**
    ...
    <script type="text/javascript" pagespeed_no_defer="">
        var appticles = {
            ...
            logo: '<?php echo isset($arr_config_premium['logo_path']) && $arr_config_premium['logo_path'] != '' ? $cdn_apps."/".$arr_config_premium['shorten_url'].'/'.$arr_config_premium['logo_path'] : '';?>',
            icon: '<?php echo isset($arr_config_premium['icon_path']) && $arr_config_premium['icon_path'] != '' ? $cdn_apps."/".$arr_config_premium['shorten_url'].'/'.$arr_config_premium['icon_path'] : '';?>',
            ...
            hasGoogle: <?php echo !isset($arr_config_premium['enable_google']) || $arr_config_premium['enable_google'] == 1 ? 'true' : 'false';?>,

            // @todo add comments token
            commentsToken: "<?php // echo $app_settings['comments_token'];?>",
            articlesPerCard: <?php echo $posts_per_page ;?>,
    ...
    <script type="text/javascript" src="<?php echo $cdn_kits;?>/others/locales2/<?php echo $locale.($supported_gzip ? '-js.gz' : '.js');?>"></script>
