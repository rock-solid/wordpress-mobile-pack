...
define("WMP_WURFL_DIR", WMP_LIBS_DIR . '/wurfl-php-1.5.1.0/WURFL/');
define("WMP_WURFL_RESOURCES_DIR", WMP_LIBS_DIR . "/wurfl-php-1.5.1.0/examples/resources/");
