Ext.define("WP.view.phone.categories.CategoryTemplates2", {
									...
									'<div class="inner">',
										...
										'<tpl if="image &amp;&amp; image.src.length &gt; 0">',
											'<div class="headline">',
												...
												'<tpl if="description &amp;&amp; description.length &gt; 0">',
													'<tpl if="this.hasSpaceForDescription()">',
											...
											'<div class="image-container" style="background-image:url(\'{[values.image.src]}\'); background-size:cover; background-position:center;">',
												'<div class="overlay"><div class="shape top" style="{[this.getShapeStyle(this.getBoxWidth()/2, "top")]};"></div></div>',
											'</div>',
										...
										'<tpl else>',
											'<div class="headline">',
												'<h1>{title}</h1>',
												'<tpl if="date &amp;&amp; date.length &gt; 0">',
													'<h3 style="width:{[this.getBoxWidth()/4]}px">{date}</h3>', 
												'</tpl>',
												'<div class="over-shape">',
													'<span class="category-name">{category_name}</span>',
												'</div>',
											...
											'<div class="overlay">',
												'<div class="shape top" style="{[this.getShapeStyle(this.getBoxWidth()/2, "top")]}"></div>',
												'<tpl if="description &amp;&amp; description.length &gt; 0">',
													'<div class="description"><p>{[this.stripHtml(values.description)]}</p></div>',
						...
						'<tpl if="xindex == 2">',
							...
							'</tpl>',
									...
									'<div class="inner">',
										...
										'<tpl if="image &amp;&amp; image.src.length &gt; 0">',
											'<div class="image-container" style="background-image:url(\'{[values.image.src]}\'); background-size:cover; background-position:center;">',
												'<div class="overlay"><div class="shape bottom" style="{[this.getShapeStyle(this.getBoxWidth()/2)]}"></div></div>',
											'</div>',
										
											'<div class="headline">',
												'<div class="over-shape"><span class="category-name" style="width:{[this.getBoxWidth()/4]}px">{category_name}</span></div>',
												'<h1>{title}</h1>',
												'<tpl if="date &amp;&amp; date.length &gt; 0">',
													"<h3>{date}</h3>",
												'</tpl>',
							...
							'</tpl>',
									...
									'<div class="inner">',
										...
										'<tpl if="image &amp;&amp; image.src.length &gt; 0">',
											...
											'<div class="image-container" style="background-image:url(\'{[values.image.src]}\'); background-size:cover; background-position:center;">',
												'<div class="overlay"><div class="shape top" style="{[this.getShapeStyle(this.getBoxWidth(), "top")]}"></div></div>',
											'</div>',
