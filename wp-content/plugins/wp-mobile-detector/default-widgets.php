...
function websitez_unregister_default_wp_widgets() {
	...
	register_widget('websitez_WP_Widget_Pages');
	register_widget('websitez_WP_Widget_Calendar');
	register_widget('websitez_WP_Widget_Archives');
	register_widget('websitez_WP_Widget_Links');
	register_widget('websitez_WP_Widget_Meta');
	register_widget('websitez_WP_Widget_Search');
	register_widget('websitez_WP_Widget_Text');
	register_widget('websitez_WP_Widget_Categories');
	register_widget('websitez_WP_Widget_Recent_Posts');
	register_widget('websitez_WP_Widget_Recent_Comments');
	register_widget('websitez_WP_Widget_RSS');
	register_widget('websitez_WP_Widget_Tag_Cloud');
	register_widget('websitez_WP_Nav_Menu_Widget');
}
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Pages extends WP_Widget {

	function websitez_WP_Widget_Pages() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Links extends WP_Widget {

	function websitez_WP_Widget_Links() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Search extends WP_Widget {

	function websitez_WP_Widget_Search() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Archives extends WP_Widget {

	function websitez_WP_Widget_Archives() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Meta extends WP_Widget {

	function websitez_WP_Widget_Meta() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Calendar extends WP_Widget {

	function websitez_WP_Widget_Calendar() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Text extends WP_Widget {

	function websitez_WP_Widget_Text() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Categories extends WP_Widget {

	function websitez_WP_Widget_Categories() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Recent_Posts extends WP_Widget {

	function websitez_WP_Widget_Recent_Posts() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Recent_Comments extends WP_Widget {

	function websitez_WP_Widget_Recent_Comments() {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_RSS extends WP_Widget {

	function websitez_WP_Widget_RSS() {
	...
	function widget($args, $instance) {
		...
		if ( $title )
			echo $before_title . $title . $after_title;
		websitez_wp_widget_rss_output( $rss, $instance );
		echo $after_widget;
	...
	function update($new_instance, $old_instance) {
		...
		return websitez_wp_widget_rss_process( $new_instance, $testurl );
	}
	...
	function form($instance) {
		...
		websitez_wp_widget_rss_form( $instance );
	}
}
 ...
 */
function websitez_wp_widget_rss_output( $rss, $args = array() ) {
	if ( is_string( $rss ) ) {
		$rss = fetch_feed($rss);
 ...
 */
function websitez_wp_widget_rss_form( $args, $inputs = null ) {
 ...
 * @return array
 */
function websitez_wp_widget_rss_process( $widget_rss, $check_feed = true ) {
 ...
 * @since 2.8.0
 */
class websitez_WP_Widget_Tag_Cloud extends WP_Widget {

	function websitez_WP_Widget_Tag_Cloud() {
 ...
 * @since 3.0.0
 */
class websitez_WP_Nav_Menu_Widget extends WP_Widget {

	function websitez_WP_Nav_Menu_Widget() {
	...
	function widget($args, $instance) {
		...
		$menu = wp_nav_menu( array( 'fallback_cb' => '', 'menu' => $nav_menu, 'echo' => 0, 'container' => '' ) );
		//Putting this hack because WP does not allow you to remove the UL surrounding the string.
		//Should most likely regex the UL out of this
		//TODO
		//$menu = preg_replace("/(<ul.*>)(\w.*)(<.*>)/ismU", "", $menu, $matches);
		$menu = str_replace(array('<ul id="menu-more-links" class="menu">','</ul>'),"",$menu);
		echo $menu;
