...
<head profile="http://gmpg.org/xfn/11">
  ...
  <meta name="description" content="<?php bloginfo('description'); ?>" />
	...
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/jquery-mobile-min.css" />
	<script src="<?php echo get_template_directory_uri(); ?>/jquery-1.4.3.min.js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/jquery-mobile-min.js"></script>
