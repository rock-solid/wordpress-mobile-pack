    ...
    <p><font style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">You must be <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php the_permalink(); ?>" rel="external">logged in</a> to post a comment.</font></p>
    ...
    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
   		...
   		<p>
        	<font style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?loggedout=true" title="Log out of this account" rel="external">Logout &raquo;</a></font>
      	</p>
