...
class ExportArticleTest extends WP_UnitTestCase
{
	...
	/**
     * Calling export_article() with a post that does not have a featured image and an image in the content returns correct data
     */
	 function test_export_article_without_featured_image_and_image_in_content_returns_correct_data()
	 {
       $published = time();
        ...
        $post_id = $this->factory->post->create(
            array(
                'post_title' => 'Article Title',
                'post_date' => date('Y-m-d H:i:s', $published),
				'post_content' => '<img src="http://localhost/wp/wp-content/uploads/test_image.jpg" /> The house is the same everywhere you go.'
            )
        );
		...
		// check feature image not in content
		$this->assertEquals('<p><img src="http://localhost/wp/wp-content/uploads/test_image.jpg" alt="test_image.jpg" /> The house is the same everywhere you go.</p>
', $data['article']['content']);
	...
	/**
     * Calling export_article() with a post that has the featured image inside the content returns data json and removes image from content
     */
    function test_export_article_with_featured_image_in_content_returns_data_and_content_without_image()
    {
		...
		// check feature image not in content
		$this->assertEquals('<p> The house is the same everywhere you go.</p>
', $data['article']['content']);
	...
	/**
     * Calling export_article() with a post that has the featured image inside the content and another image returns data json and only removes the featured image from content
     */
    function test_export_article_with_featured_image_in_content_and_another_image_returns_data_and_content_without_featured_image()
    {
        ...
        $post_id = $this->factory->post->create(
            array(
                'post_title' => 'Article Title',
                'post_date' => date('Y-m-d H:i:s', $published),
				'post_content' => '<img src="http://localhost/wp/wp-content/uploads/test_image.jpg" /> The house is the same everywhere you go. <img src="http://localhost/wp/wp-content/uploads/another_image.jpg" />'
            )
        );
		...
		// check feature image not in content
		$this->assertEquals('<p> The house is the same everywhere you go. <img src="http://localhost/wp/wp-content/uploads/another_image.jpg" alt="another_image.jpg" /></p>
', $data['article']['content']);
 	...
 	/**
     * Calling export_article() with a post that has the featured resized image inside the content returns data json and removes image from content
     */
    function test_export_article_with_featured_resized_image_in_content_returns_data_and_content_without_image()
    {
        ...
        $post_id = $this->factory->post->create(
            array(
                'post_title' => 'Article Title',
                'post_date' => date('Y-m-d H:i:s', $published),
				'post_content' => '<img src="http://localhost/wp/wp-content/uploads/test_image-768x1024.jpg" /> The house is the same everywhere you go.'
            )
        );

        // mock an attachment image and link it to the post
        $filename = "test_image-768x1024.jpg";
        $wp_upload_dir = wp_upload_dir();
        ...
        wp_update_attachment_metadata($attach_id, array(
			...
			'sizes' => array(
				'thumbnail' => array(
					'file' => 'test_image-150x150.jpg',
					'width' => 150,
					'height' => 150,
					'mime-type' => 'image/jpeg'
				),
				'medium' => array(
					'file' => 'test_image-225x300.jpg',
					'width' => 225,
					'height' => 300,
					'mime-type' => 'image/jpeg'
				),
				'medium_large' => array(
					'file' => 'test_image-768x1024.jpg',
					'width' => 768,
					'height' => 1024,
					'mime-type' => 'image/jpeg'
				),
...
', $data['article']['content']);
 	...
 	/**
     * Calling export_article() with a post that has the featured image resized and the same image but with a different size inside the content returns data json and removes image from content
     */
    function test_export_article_with_featured_resized_image_with_different_size_than_featured_image_in_content_returns_data_and_content_without_image()
    {
        ...
        $post_id = $this->factory->post->create(
            array(
                'post_title' => 'Article Title',
                'post_date' => date('Y-m-d H:i:s', $published),
				'post_content' => '<img src="http://localhost/wp/wp-content/uploads/test_image-225x300.jpg" /> The house is the same everywhere you go.'
            )
        );
