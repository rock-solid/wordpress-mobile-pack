...
function WMPPreloader() {
    ...
    this.remove = function (time) {
        ...
        preloader_container.fadeOut({duration: time}, function () {
...
function WMPMessage() {
    ...
    this.defaultParams = {
        ...
        message: "",
        closeFunction: null
    };	// for redirect purpose...., after the message is closed
    ...
    this.view = function (params) {
        ...
        this.container.data("timerInterval", setInterval(function () {
            JSObject.container.trigger("countTimer")
        }, 1000));
    ...
    this.remove = function () {
        ...
        JSObject.container.slideUp(JSObject.defaultParams.speed, function () {
            ...
            spacerDiv.slideUp(200, function () {
                jQuery(this).remove();
            })
        });
    }
