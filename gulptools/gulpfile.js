...
mergeTasks.forEach(function(taskName) {
    gulp.task(taskName, function() {
        ...
        return gulp.src(['files/_variables_colors' + colorScheme + '.scss', 'files/_variables_fonts' + fonts + '.scss', 'scss/phone.scss'])
...
compileTasks.forEach(function(taskName) {
    gulp.task(taskName, function() {
        ...
        return sass('merged/colors-' + colorScheme + '-fonts-' + fontsScheme + '.scss', { style: 'compressed' })
            ...
            .pipe(gulp.dest('../themes/base/includes/resources/css/'));
    });
});
